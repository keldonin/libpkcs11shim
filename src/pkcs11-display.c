...
#define CKA_NSS CKA_NETSCAPE

#define CKA_NSS_URL                (CKA_NETSCAPE +  1)
#define CKA_NSS_EMAIL              (CKA_NETSCAPE +  2)
#define CKA_NSS_SMIME_INFO         (CKA_NETSCAPE +  3)
#define CKA_NSS_SMIME_TIMESTAMP    (CKA_NETSCAPE +  4)
#define CKA_NSS_PKCS8_SALT         (CKA_NETSCAPE +  5)
#define CKA_NSS_PASSWORD_CHECK     (CKA_NETSCAPE +  6)
#define CKA_NSS_EXPIRES            (CKA_NETSCAPE +  7)
#define CKA_NSS_KRL                (CKA_NETSCAPE +  8)
#define CKA_NSS_PQG_COUNTER        (CKA_NETSCAPE +  20)
#define CKA_NSS_PQG_SEED           (CKA_NETSCAPE +  21)
#define CKA_NSS_PQG_H              (CKA_NETSCAPE +  22)
#define CKA_NSS_PQG_SEED_BITS      (CKA_NETSCAPE +  23)

#define CKA_NSS_TRUST (CKA_NSS + 0x2000)

/* "Usage" key information */
#define CKA_NSS_TRUST_DIGITAL_SIGNATURE     (CKA_NSS_TRUST +  1)
#define CKA_NSS_TRUST_NON_REPUDIATION       (CKA_NSS_TRUST +  2)
#define CKA_NSS_TRUST_KEY_ENCIPHERMENT      (CKA_NSS_TRUST +  3)
#define CKA_NSS_TRUST_DATA_ENCIPHERMENT     (CKA_NSS_TRUST +  4)
#define CKA_NSS_TRUST_KEY_AGREEMENT         (CKA_NSS_TRUST +  5)
#define CKA_NSS_TRUST_KEY_CERT_SIGN         (CKA_NSS_TRUST +  6)
#define CKA_NSS_TRUST_CRL_SIGN              (CKA_NSS_TRUST +  7)

/* "Purpose" trust information */
#define CKA_NSS_TRUST_SERVER_AUTH           (CKA_NSS_TRUST +  8)
#define CKA_NSS_TRUST_CLIENT_AUTH           (CKA_NSS_TRUST +  9)
#define CKA_NSS_TRUST_CODE_SIGNING          (CKA_NSS_TRUST + 10)
#define CKA_NSS_TRUST_EMAIL_PROTECTION      (CKA_NSS_TRUST + 11)
#define CKA_NSS_TRUST_IPSEC_END_SYSTEM      (CKA_NSS_TRUST + 12)
#define CKA_NSS_TRUST_IPSEC_TUNNEL          (CKA_NSS_TRUST + 13)
#define CKA_NSS_TRUST_IPSEC_USER            (CKA_NSS_TRUST + 14)
#define CKA_NSS_TRUST_TIME_STAMPING         (CKA_NSS_TRUST + 15)
#define CKA_NSS_CERT_SHA1_HASH		    (CKA_NSS_TRUST + 100)
#define CKA_NSS_CERT_MD5_HASH			(CKA_NSS_TRUST + 101)
...
enum_spec ck_types[] = {
    ...
    { HWF_T, ck_hwf_s, sizeof(ck_hwf_s) / SZ_SPECS, "CK_HW_FEATURE_TYPE"  },
...
static enum_spec ck_hwf_t[] = { { HWF_T, ck_hwf_s, sizeof(ck_hwf_s) / SZ_SPECS, "CK_HW_FEATURE_TYPE" } };
...
type_spec ck_attribute_specs[] = {
    ...
    { CKA_KEY_GEN_MECHANISM , "CKA_KEY_GEN_MECHANISM", print_generic, NULL },
    ...
    { CKA_HW_FEATURE_TYPE   , "CKA_HW_FEATURE_TYPE  ", print_enum, ck_hwf_t },
    ...
    { CKA_PROFILE_ID         , "CKA_PROFILE_ID        ", print_generic, NULL },
    ...
    { CKA_X2RATCHET_RK       , "CKA_X2RATCHET_RK      ", print_generic, NULL },
    ...
    /* NSS (Netscape) */
    { CKA_NSS_URL, "CKA_NSS_URL(NSS)                         ", print_print, NULL },
    { CKA_NSS_EMAIL, "CKA_NSS_EMAIL(NSS)                     ", print_print, NULL },
    { CKA_NSS_SMIME_INFO, "CKA_NSS_SMIME_INFO(NSS)           ", print_generic, NULL },
    ...
    { CKA_NSS_TRUST_NON_REPUDIATION, "CKA_NSS_TRUST_NON_REPUDIATION(NSS)       ", print_boolean, NULL },
    { CKA_NSS_TRUST_KEY_ENCIPHERMENT, "CKA_NSS_TRUST_KEY_ENCIPHERMENT(NSS)     ", print_boolean, NULL },
    { CKA_NSS_TRUST_DATA_ENCIPHERMENT, "CKA_NSS_TRUST_DATA_ENCIPHERMENT(NSS)   ", print_boolean, NULL },
    { CKA_NSS_TRUST_KEY_AGREEMENT, "CKA_NSS_TRUST_KEY_AGREEMENT(NSS)           ", print_boolean, NULL },
    { CKA_NSS_TRUST_KEY_CERT_SIGN, "CKA_NSS_TRUST_KEY_CERT_SIGN(NSS)           ", print_boolean, NULL },
    { CKA_NSS_TRUST_CRL_SIGN, "CKA_NSS_TRUST_CRL_SIGN(NSS)                     ", print_boolean, NULL },
    { CKA_NSS_TRUST_SERVER_AUTH, "CKA_NSS_TRUST_SERVER_AUTH(NSS)               ", print_boolean, NULL },
    { CKA_NSS_TRUST_CLIENT_AUTH, "CKA_NSS_TRUST_CLIENT_AUTH(NSS)               ", print_boolean, NULL },
    { CKA_NSS_TRUST_CODE_SIGNING, "CKA_NSS_TRUST_CODE_SIGNING(NSS)             ", print_boolean, NULL },
    { CKA_NSS_TRUST_EMAIL_PROTECTION, "CKA_NSS_TRUST_EMAIL_PROTECTION(NSS)     ", print_boolean, NULL },
    { CKA_NSS_TRUST_IPSEC_END_SYSTEM, "CKA_NSS_TRUST_IPSEC_END_SYSTEM(NSS)     ", print_boolean, NULL },
    { CKA_NSS_TRUST_IPSEC_TUNNEL, "CKA_NSS_TRUST_IPSEC_TUNNEL(NSS)             ", print_boolean, NULL },
    { CKA_NSS_TRUST_IPSEC_USER, "CKA_NSS_TRUST_IPSEC_USER(NSS)                 ", print_boolean, NULL },
    { CKA_NSS_TRUST_TIME_STAMPING, "CKA_NSS_TRUST_TIME_STAMPING(NSS)           ", print_boolean, NULL },
    { CKA_NSS_CERT_SHA1_HASH, "CKA_NSS_CERT_SHA1_HASH(NSS)                     ", print_generic, NULL },
    { CKA_NSS_CERT_MD5_HASH, "CKA_NSS_CERT_MD5_HASH(NSS)                       ", print_generic, NULL },
};
